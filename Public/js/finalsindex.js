...
$(function(){
	...
	if(text.length > 4){
		$("#songname").css({"font-size":19-(text.length - 4)*4 +"px"});
	}
	

	var marginleft= -Math.floor($(".container").width()/2);
	...
	$("#comment").click(function(){
		$(".send").css({"bottom":"20px","left":"50px"});
		/*$(".commentList").css("display","block");*/
		$(".songtext").css("display","none");
		$("#comment_guidebox").css({"color":"#2b7f2b","background":"#fff"});
		$("#songtext_guidebox").css({"color":"#8c8c8c","background":"transparent "});
	});
	$("#songtext").click(function(){
		$(".send").css({"bottom":"99999px","left":"99999px"});
	/*	$(".commentList").css("display","none");*/
		$(".songtext").css("display","block");
		$("#songtext_guidebox").css({"color":"#2b7f2b","background":"#fff"});
		$("#comment_guidebox").css({"color":"#8c8c8c","background":"transparent"});
	});
	$(".Clist").hover(function(){

		$(".dumascroll_bar").css("visibility","visible");
		$(".dumascroll_handle").css("visibility","visible");
		$(".dumascroll_handle_a").css("visibility","visible");
	},
	function(e){
		$(".dumascroll_bar").css("visibility","hidden");
		$(".dumascroll_handle").css("visibility","hidden");
		$(".dumascroll_handle_a").css("visibility","hidden");
		
	});


	$(".mode2Btn").bind("click",function(){
		if(playMode=="circle"){
			$(this).removeClass();
			$(this).addClass("modebtn");
			setCookie("playMode","random",365);
			playMode = "random";
		}
		else{
			$(this).removeClass();
			$(this).addClass("mode2Btn");
			setCookie("playMode","circle",365);
			playMode = "circle";
		}
		
	});	
	$(".CDlogo").hover(function(){
		console.log("!!");
		$(".CDlogo").animate({"opacity":"1","-moz-opacity":"1","filter":"alpha(opacity=100)"},"slow");
	},function(){
		$(".CDlogo").animate({"opacity":"0","-moz-opacity":"0","filter":"alpha(opacity=100)"},"slow");
	});
});
