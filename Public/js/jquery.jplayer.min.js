 ...
 */(function(b, f) {
    ...
    b.fn.jPlayer = function(a) {
        ...
        return a = !c && d.length ? b.extend.apply(null, [ !0, a ].concat(d)) : a, c && "_" === a.charAt(0) ? e : (c ? this.each(function() {
    ...
    }, "function" != typeof b.fn.stop && (b.fn.stop = function() {}), b.jPlayer.emulateMethods = "load play pause", b.jPlayer.emulateStatus = "src readyState networkState currentTime duration paused ended playbackRate", b.jPlayer.emulateOptions = "muted volume", b.jPlayer.reservedEvent = "ready flashreset resize repeat error warning", b.jPlayer.event = {}, b.each("ready flashreset resize repeat click error warning loadstart progress suspend abort emptied stalled play pause loadedmetadata loadeddata waiting playing canplay canplaythrough seeking seeked timeupdate ended ratechange durationchange volumechange".split(" "), function() {
        b.jPlayer.event[this] = "jPlayer_" + this;
    }), b.jPlayer.htmlEvent = "loadstart abort emptied stalled loadedmetadata loadeddata canplay canplaythrough ratechange".split(" "), b.jPlayer.pause = function() {
    ...
    l.prototype = {
        ...
        "time": function(a) {
            ...
            return a = this.options.timeFormat.showHour ? c.getUTCMinutes() : c.getUTCMinutes() + 60 * b, c = this.options.timeFormat.showMin ? c.getUTCSeconds() : c.getUTCSeconds() + 60 * a, b = this.options.timeFormat.padHour && 10 > b ? "0" + b : b, a = this.options.timeFormat.padMin && 10 > a ? "0" + a : a, c = this.options.timeFormat.padSec && 10 > c ? "0" + c : c, b = "" + (this.options.timeFormat.showHour ? b + this.options.timeFormat.sepHour : ""), b += this.options.timeFormat.showMin ? a + this.options.timeFormat.sepMin : "", b += this.options.timeFormat.showSec ? c + this.options.timeFormat.sepSec : "";
        }
    };
    var m = new l;
    b.jPlayer.convertTime = function(a) {
        ...
        return a = /(webkit)[ \/]([\w.]+)/.exec(a) || b.exec(a) || d.exec(a) || 0 > a.indexOf("compatible") && e.exec(a) || [], {
            "browser": a[1] || "",
            "version": a[2] || "0"
        };
    }, b.jPlayer.uaPlatform = function(a) {
        var b = a.toLowerCase(), d = /(android)/, e = /(mobile)/;
        return a = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/.exec(b) || [], b = /(ipad|playbook)/.exec(b) || !e.exec(b) && d.exec(b) || [], a[1] && (a[1] = a[1].replace(/\s/g, "_")), {
            "platform": a[1] || "",
            "tablet": b[1] || ""
        };
    }, b.jPlayer.browser = {}, b.jPlayer.platform = {};
    var j = b.jPlayer.uaBrowser(navigator.userAgent);
    j.browser && (b.jPlayer.browser[j.browser] = !0, b.jPlayer.browser.version = j.version), j = b.jPlayer.uaPlatform(navigator.userAgent), j.platform && (b.jPlayer.platform[j.platform] = !0, b.jPlayer.platform.mobile = !j.tablet, b.jPlayer.platform.tablet = !!j.tablet), b.jPlayer.getDocMode = function() {
        var a;
        return b.jPlayer.browser.msie && (document.documentMode ? a = document.documentMode : (a = 5, document.compatMode && "CSS1Compat" === document.compatMode && (a = 7))), a;
            ...
            if (b.spec) {
                ...
                b.api = {
                    ...
                    "fullscreenElement": function(b) {
                        return b = b ? b : a, b[k[1]];
                    },
                    "requestFullscreen": function(a) {
                        return a[k[2]]();
                    },
                    "exitFullscreen": function(b) {
                        return b = b ? b : a, b[k[3]]();
                    }
                }, b.event = {
    ...
    }, b.jPlayer.nativeFeatures.init(), b.jPlayer.focus = null, b.jPlayer.keyIgnoreElementNames = "INPUT TEXTAREA";
    var n = function(a) {
    ...
    b.jPlayer.keys = function(a) {
        b(document.documentElement).unbind("keydown.jPlayer"), a && b(document.documentElement).bind("keydown.jPlayer", n);
        ...
        "_init": function() {
            ...
            this.element.empty(), this.status = b.extend({}, this.status), this.internal = b.extend({}, this.internal), this.options.timeFormat = b.extend({}, b.jPlayer.timeFormat, this.options.timeFormat), this.internal.cmdsIgnored = b.jPlayer.platform.ipad || b.jPlayer.platform.iphone || b.jPlayer.platform.ipod, this.internal.domNode = this.element.get(0), this.options.keyEnabled && !b.jPlayer.focus && (b.jPlayer.focus = this), this.formats = [], this.solutions = [], this.require = {}, this.htmlElement = {}, this.html = {}, this.html.audio = {}, this.html.video = {}, this.flash = {}, this.css = {}, this.css.cs = {}, this.css.jq = {}, this.ancestorJq = [], this.options.volume = this._limitValue(this.options.volume, 0, 1), b.each(this.options.supplied.toLowerCase().split(","), function(c, d) {
            ...
            }), this.internal.instance = "jp_" + this.count, this.instances[this.internal.instance] = this.element, this.element.attr("id") || this.element.attr("id", this.options.idPrefix + "_jplayer_" + this.count), this.internal.self = b.extend({}, {
            ...
            }, this.element.append(this.htmlElement.poster), this.internal.poster.jq = b("#" + this.internal.poster.id), this.internal.poster.jq.css({
                ...
                a.html.canPlay[c] = a.html[a.format[c].media].available && "" !== a.htmlElement[a.format[c].media].canPlayType(a.format[c].codec), a.flash.canPlay[c] = a.format[c].flashCanPlay && a.flash.available;
            ...
            this.html.used && (this.html.audio.available && (this._addHtmlEventListeners(this.htmlElement.audio, this.html.audio), this.element.append(this.htmlElement.audio), this.internal.audio.jq = b("#" + this.internal.audio.id)), this.html.video.available && (this._addHtmlEventListeners(this.htmlElement.video, this.html.video), this.element.append(this.htmlElement.video), this.internal.video.jq = b("#" + this.internal.video.id), this.status.nativeVideoControls ? this.internal.video.jq.css({
                ...
                a.internal.ready = !0, a.version.flash = "n/a", a._trigger(b.jPlayer.event.repeat), a._trigger(b.jPlayer.event.ready);
            }, 100), this._updateNativeVideoControls(), this.css.jq.videoPlay.length && this.css.jq.videoPlay.hide(), b.jPlayer.prototype.count++;
        },
        "destroy": function() {
            this.clearMedia(), this._removeUiClass(), this.css.jq.currentTime.length && this.css.jq.currentTime.text(""), this.css.jq.duration.length && this.css.jq.duration.text(""), b.each(this.css.jq, function(a, b) {
        ...
        "_addHtmlEventListeners": function(a, c) {
            var d = this;
            a.preload = this.options.preload, a.muted = this.options.muted, a.volume = this.options.volume, a.addEventListener("progress", function() {
        ...
        "_getHtmlStatus": function(a, b) {
            var d = 0, e = 0, g = 0, f = 0;
            isFinite(a.duration) && (this.status.duration = a.duration), d = a.currentTime, e = 0 < this.status.duration ? 100 * d / this.status.duration : 0, "object" == typeof a.seekable && 0 < a.seekable.length ? (g = 0 < this.status.duration ? 100 * a.seekable.end(a.seekable.length - 1) / this.status.duration : 100, f = 0 < this.status.duration ? 100 * a.currentTime / a.seekable.end(a.seekable.length - 1) : 0) : (g = 100, f = e), b && (e = f = d = 0), this.status.seekPercent = g, this.status.currentPercentRelative = f, this.status.currentPercentAbsolute = e, this.status.currentTime = d, this.status.videoWidth = a.videoWidth, this.status.videoHeight = a.videoHeight, this.status.readyState = a.readyState, this.status.networkState = a.networkState, this.status.playbackRate = a.playbackRate, this.status.ended = a.ended;
        },
        "_resetStatus": function() {
            this.status = b.extend({}, this.status, b.jPlayer.prototype.status);
        },
        "_trigger": function(a, c, d) {
            a = b.Event(a), a.jPlayer = {}, a.jPlayer.version = b.extend({}, this.version), a.jPlayer.options = b.extend(!0, {}, this.options), a.jPlayer.status = b.extend(!0, {}, this.status), a.jPlayer.html = b.extend(!0, {}, this.html), a.jPlayer.flash = b.extend(!0, {}, this.flash), c && (a.jPlayer.error = b.extend({}, c)), d && (a.jPlayer.warning = b.extend({}, d)), this.element.trigger(a);
        },
            ...
            if (a === b.jPlayer.event.ready) if (this.internal.ready) {
                if (this.flash.gate) {
                    if (this.status.srcSet) {
                        ...
                        this.setMedia(this.status.media), 0 < d && (e ? this.pause(d) : this.play(d));
                    }
            ...
            this._resetMedia(), this._resetGate(), this._resetActive(), b.each(this.formats, function(e, f) {
                ...
                b.each(c.solutions, function(b, e) {
                    if (c[e].support[f] && c._validString(a[f])) {
                        var g = "html" === e;
                        return j ? (g ? (c.html.video.gate = !0, c._html_setVideo(a), c.html.active = !0) : (c.flash.gate = !0, c._flash_setVideo(a), c.flash.active = !0), c.css.jq.videoPlay.length && c.css.jq.videoPlay.show(), c.status.video = !0) : (g ? (c.html.audio.gate = !0, c._html_setAudio(a), c.html.active = !0) : (c.flash.gate = !0, c._flash_setAudio(a), c.flash.active = !0), c.css.jq.videoPlay.length && c.css.jq.videoPlay.hide(), c.status.video = !1), d = !0, !1;
                    }
                });
                if (d) return !1;
            }), d ? ((!this.status.nativeVideoControls || !this.html.video.gate) && this._validString(a.poster) && (e ? this.htmlElement.poster.src = a.poster : this.internal.poster.jq.show()), this.status.srcSet = !0, this.status.media = b.extend({}, a), this._updateButtons(!1), this._updateInterface()) : this._error({
        ...
        "_muted": function(a) {
            this.options.muted = a, this.html.used && this._html_mute(a), this.flash.used && this._flash_mute(a), !this.html.video.gate && !this.html.audio.gate && (this._updateMute(a), this._updateVolume(this.options.volume), this._trigger(b.jPlayer.event.volumechange));
        },
        "mute": function(a) {
        ...
        "_updateMute": function(a) {
            a === f && (a = this.options.muted), this.css.jq.mute.length && this.css.jq.unmute.length && (this.status.noVolume ? (this.css.jq.mute.hide(), this.css.jq.unmute.hide()) : a ? (this.css.jq.mute.hide(), this.css.jq.unmute.show()) : (this.css.jq.mute.show(), this.css.jq.unmute.hide()));
        },
        "volume": function(a) {
            a = this._limitValue(a, 0, 1), this.options.volume = a, this.html.used && this._html_volume(a), this.flash.used && this._flash_volume(a), !this.html.video.gate && !this.html.audio.gate && (this._updateVolume(a), this._trigger(b.jPlayer.event.volumechange));
        },
        "volumeBar": function(a) {
            if (this.css.jq.volumeBar.length) {
                var c = b(a.currentTarget), d = c.offset(), e = a.pageX - d.left, g = c.width();
                a = c.height() - a.pageY + d.top, c = c.height(), this.options.verticalVolume ? this.volume(a / c) : this.volume(e / g);
            }
        ...
        "_cssSelectorAncestor": function(a) {
            var c = this;
            this.options.cssSelectorAncestor = a, this._removeUiClass(), this.ancestorJq = a ? b(a) : [], a && 1 !== this.ancestorJq.length && this._warning({
        ...
        "_cssSelector": function(a, c) {
            ...
            "string" == typeof c ? b.jPlayer.prototype.options.cssSelector[a] ? (this.css.jq[a] && this.css.jq[a].length && this.css.jq[a].unbind(".jPlayer"), this.options.cssSelector[a] = c, this.css.cs[a] = this.options.cssSelectorAncestor + " " + c, this.css.jq[a] = c ? b(this.css.cs[a]) : [], this.css.jq[a].length && this.css.jq[a].bind("click.jPlayer", function(c) {
                c.preventDefault(), d[a](c), b(this).blur();
        ...
        "seekBar": function(a) {
            if (this.css.jq.seekBar.length) {
                ...
                a = a.pageX - d.left, c = c.width(), this.playHead(100 * a / c);
            }
        },
        "playBar": function() {},
        "repeat": function() {
        ...
        "_setOption": function(a, c) {
            ...
            switch (a) {
              ...
              case "fullWindow":
                ...
                break;
              case "size":
                !this.options.fullWindow && this.options[a].cssClass !== c.cssClass && this._removeUiClass(), this.options[a] = b.extend({}, this.options[a], c), this._refreshSize();
                break;
              case "sizeFull":
                this.options.fullWindow && this.options[a].cssClass !== c.cssClass && this._removeUiClass(), this.options[a] = b.extend({}, this.options[a], c), this._refreshSize();
                break;
              ...
              case "nativeVideoControls":
                this.options[a] = b.extend({}, this.options[a], c), this.status.nativeVideoControls = this._uaBlocklist(this.options.nativeVideoControls), this._restrictNativeVideoControls(), this._updateNativeVideoControls();
                break;
              case "noFullWindow":
                this.options[a] = b.extend({}, this.options[a], c), this.status.nativeVideoControls = this._uaBlocklist(this.options.nativeVideoControls), this.status.noFullWindow = this._uaBlocklist(this.options.noFullWindow), this._restrictNativeVideoControls(), this._updateButtons();
                break;
              case "noVolume":
                this.options[a] = b.extend({}, this.options[a], c), this.status.noVolume = this._uaBlocklist(this.options.noVolume), this._updateVolume(), this._updateMute();
                break;
              case "emulateHtml":
        ...
        "_refreshSize": function() {
            this._setSize(), this._addUiClass(), this._updateSize(), this._updateButtons(), this._updateAutohide(), this._trigger(b.jPlayer.event.resize);
        },
        "_setSize": function() {
        ...
        "_requestFullscreen": function() {
            ...
            c.used.webkitVideo && (a = this.htmlElement.video), c.api.fullscreenEnabled && c.api.requestFullscreen(a);
        },
        "_exitFullscreen": function() {
            var a = b.jPlayer.nativeFeatures.fullscreen, c;
            a.used.webkitVideo && (c = this.htmlElement.video), a.api.fullscreenEnabled && a.api.exitFullscreen(c);
        },
        "_html_initMedia": function(a) {
            var c = b(this.htmlElement.media).empty();
            b.each(a.track || [], function(a, b) {
                var g = document.createElement("track");
                g.setAttribute("kind", b.kind ? b.kind : ""), g.setAttribute("src", b.src ? b.src : ""), g.setAttribute("srclang", b.srclang ? b.srclang : ""), g.setAttribute("label", b.label ? b.label : ""), b.def && g.setAttribute("default", b.def), c.append(g);
        ...
        "_html_play": function(a) {
            ...
            if (isNaN(a)) d.play(); else {
                ...
                try {
                    if (!(!d.seekable || "object" == typeof d.seekable && 0 < d.seekable.length)) throw 1;
        ...
        "_html_pause": function(a) {
            var b = this, d = this.htmlElement.media;
            0 < a ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId), d.pause();
            if (!isNaN(a)) try {
                if (!(!d.seekable || "object" == typeof d.seekable && 0 < d.seekable.length)) throw 1;
                d.currentTime = a;
            } catch (e) {
        ...
        "_html_playHead": function(a) {
            ...
            this._html_load();
            try {
                if ("object" == typeof d.seekable && 0 < d.seekable.length) d.currentTime = a * d.seekable.end(d.seekable.length - 1) / 100; else {
                    if (!(0 < d.duration && !isNaN(d.duration))) throw "e";
